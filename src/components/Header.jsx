                ...
                <nav>
                    ...
                    <div className={classes.middleHeader}>
                        <div className={classes.aboutUs}>
                            <Link to='/about' className={classes.linkStylesAbout}><p>About us</p></Link>
                        </div>
                        <div className={classes.delAndPay}>
                            <Link to='/deliveryAndPayment' className={classes.linkStylesAbout}><p>Delivery and Payment</p></Link>
                        </div>
                        <div className={classes.contacts}>
                            <a className={classes.linkStylesAbout} href='#myFooter'><p>Contacts</p></a>
                        </div>
                    </div>
                    <div className={classes.rightHeader}>
                        <div className={classes.icons}>
                            <img src={bagImg} className={`${classes.cart} ${cartOpen && classes.active}`} onClick={ () => setCartOpen(cartOpen = !cartOpen)}/>
{/*если cartOpen true */}   {cartOpen && ( 
